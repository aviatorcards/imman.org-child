 ...
 * Sent when a user's account has been permanently deleted.
 *
      ...
      <table width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;background:#FAF8F5;border-radius:8px;overflow:hidden;box-shadow:0 4px 20px rgba(42,80,200,0.10);">
        ...
        <tr>
          <td style="padding:40px 44px 36px;">
            ...
            <!-- Headline -->
            <h1 style="font-family:Georgia,'Times New Roman',serif;font-size:26px;font-weight:900;color:#1b3380;text-align:center;margin:0 0 10px;line-height:1.25;">Account Deleted</h1>
            <p style="font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#5c6470;text-align:center;line-height:1.65;margin:0 0 28px;">Your account and all associated personal data have been permanently removed from our system.</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="background:#e7ecf5;border-left:4px solid #2a50c8;border-radius:0 6px 6px 0;padding:16px 20px;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#5c6470;line-height:1.55;">
                  If your account was deleted by mistake, please <a href="mailto:{admin_email}" style="color:#2a50c8;text-decoration:none;font-weight:600;">contact us</a> and we'll do our best to help.
                </td>
              </tr>
            </table>
        ...
        <tr>
          <td style="background:#F3F0EB;border-top:2px solid #e7ecf5;padding:22px 44px;text-align:center;">
            <p style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#9aa3b0;margin:0 0 4px;">Thank you for your time as part of the community.</p>
