 ...
 * Sent when a user updates their account information.
 *
      ...
      <table width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;background:#FAF8F5;border-radius:8px;overflow:hidden;box-shadow:0 4px 20px rgba(42,80,200,0.10);">
        ...
        <tr>
          <td style="padding:40px 44px 36px;">
            ...
            <!-- Headline -->
            <h1 style="font-family:Georgia,'Times New Roman',serif;font-size:26px;font-weight:900;color:#1b3380;text-align:center;margin:0 0 10px;line-height:1.25;">Account Updated</h1>
            <p style="font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#5c6470;text-align:center;line-height:1.65;margin:0 0 10px;">Your account information was recently changed. If this was you, you're all set.</p>

            <!-- CTA Button -->
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td align="center" style="padding:20px 0 36px;">
                  <a href="{user_account_link}" style="display:inline-block;background:#e0a92e;color:#16181d;font-family:Georgia,'Times New Roman',serif;font-size:15px;font-weight:700;text-decoration:none;padding:14px 36px;border-radius:5px;letter-spacing:0.03em;">View Your Account</a>
                </td>
              </tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="background:#fff8e7;border-left:4px solid #e0a92e;border-radius:0 6px 6px 0;padding:16px 20px;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#5c6470;line-height:1.55;">
                  ...
                  If you didn't make this change and think your account may have been accessed by someone else, please <a href="mailto:{admin_email}" style="color:#2a50c8;text-decoration:none;font-weight:600;">contact us immediately</a>.
                </td>
              </tr>
            </table>
