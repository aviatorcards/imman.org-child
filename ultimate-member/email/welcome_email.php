 ...
 * Sent when a user's account is automatically approved upon registration.
 *
      ...
      <table width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;background:#FAF8F5;border-radius:8px;overflow:hidden;box-shadow:0 4px 20px rgba(42,80,200,0.10);">
        ...
        <tr>
          <td style="padding:40px 44px 36px;">
            ...
            <!-- Headline -->
            <h1 style="font-family:Georgia,'Times New Roman',serif;font-size:26px;font-weight:900;color:#1b3380;text-align:center;margin:0 0 10px;line-height:1.25;">Welcome to the Network!</h1>
            <p style="font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#5c6470;text-align:center;line-height:1.65;margin:0 0 32px;">Your account is active and ready to go. We're glad to have you as part of Indiana's musician community.</p>

            <!-- CTA Button -->
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td align="center" style="padding:0 0 36px;">
                  <a href="{action_url}" style="display:inline-block;background:#e0a92e;color:#16181d;font-family:Georgia,'Times New Roman',serif;font-size:15px;font-weight:700;text-decoration:none;padding:14px 36px;border-radius:5px;letter-spacing:0.03em;">{action_title}</a>
                </td>
              </tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="background:#e7ecf5;border-radius:6px;padding:16px 20px;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#5c6470;text-align:center;line-height:1.55;">
                  Questions or need help getting started? Reach us at <a href="mailto:{admin_email}" style="color:#2a50c8;text-decoration:none;font-weight:600;">{admin_email}</a>
                </td>
              </tr>
            </table>
